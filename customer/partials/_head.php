...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="../admin/assets/img/icons/ashopping-cart.png">
    <link rel="icon" type="image/png" sizes="32x32" href="../admin/assets/img/icons/shopping-cart.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../admin/assets/img/icons/shopping-cart.png">
