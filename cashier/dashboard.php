...
<body>
  ...
  <div class="main-content">
    ...
    ?>
    <!-- Header -->
    <div style="background-image: url(../admin/assets/img/theme/munuki_top.jpg); background-size: cover;" class="header  pb-8 pt-5 pt-md-8">
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM  sms_orders ORDER BY `sms_orders`.`created_at` DESC LIMIT 7 ";
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM   sms_payments   ORDER BY `sms_payments`.`created_at` DESC LIMIT 7 ";
                  $stmt = $mysqli->prepare($ret);
                  $stmt->execute();
                  $res = $stmt->get_result();
